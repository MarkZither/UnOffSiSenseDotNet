...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class GetGroupUsersOKResponseItem
    {
        /// <summary>
        /// Initializes a new instance of the GetGroupUsersOKResponseItem
        /// class.
        /// </summary>
        public GetGroupUsersOKResponseItem()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        public GetGroupUsersOKResponseItem(string _id = default(string), bool? active = default(bool?), bool? activeDirectory = default(bool?), IList<object> adgroups = default(IList<object>), string baseRoleName = default(string), bool? changePasswordState = default(bool?), System.DateTime? created = default(System.DateTime?), string createdSso = default(string), string dn = default(string), string email = default(string), string firstName = default(string), IList<string> groups = default(IList<string>), string hash = default(string), System.DateTime? lastLogin = default(System.DateTime?), string lastName = default(string), System.DateTime? lastUpdated = default(System.DateTime?), string ldapDomainId = default(string), System.DateTime? pendingExpiration = default(System.DateTime?), GetGroupUsersOKResponseItemPreferences preferences = default(GetGroupUsersOKResponseItemPreferences), string principalName = default(string), string roleId = default(string), string roleName = default(string), string uSNChanged = default(string), string userName = default(string))
        {
            this._id = _id;
            Active = active;
        ...
        public GetGroupUsersOKResponseItemPreferences Preferences { get; set; }
