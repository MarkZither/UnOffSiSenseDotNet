...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class SecuritySchema
    {
        /// <summary>
        /// Initializes a new instance of the SecuritySchema class.
        /// </summary>
        ...
        /// 'server'</param>
        public SecuritySchema(double? cookieExp = default(double?), string passwordRegex = default(string), string passwordError = default(string), double? defaultTimeout = default(double?), double? adminsTimeout = default(double?), string authenticationMode = default(string), IList<string> embeddedDomains = default(IList<string>))
        {
            CookieExp = cookieExp;
