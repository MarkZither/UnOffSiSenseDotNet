...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the GroupUpdate class.
        /// </summary>
        public GroupUpdate()
        {
            CustomInit();
        ...
        /// Initializes a new instance of the GroupUpdate class.
        /// </summary>
        public GroupUpdate(string _id = default(string), string name = default(string), System.DateTime? created = default(System.DateTime?), string mail = default(string), string roleId = default(string), string baseRoleName = default(string), string cnname = default(string), string dn = default(string), IList<string> member = default(IList<string>), string uSNChanged = default(string), string objectSid = default(string), System.DateTime? lastUpdated = default(System.DateTime?), string defaultRole = default(string), string language = default(string), double? timeout = default(double?))
        {
            this._id = _id;
            Name = name;
            Created = created;
