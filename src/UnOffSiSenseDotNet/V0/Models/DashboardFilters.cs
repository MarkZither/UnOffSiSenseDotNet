...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class DashboardFilters
    {
        /// <summary>
        /// Initializes a new instance of the DashboardFilters class.
        /// </summary>
        ...
        /// Initializes a new instance of the DashboardFilters class.
        /// </summary>
        public DashboardFilters(bool? advanced = default(bool?), bool? create = default(bool?), bool? modifyType = default(bool?), bool? onOff = default(bool?), bool? toggleAutoUpdate = default(bool?), bool? toggleExpansion = default(bool?))
        {
            Advanced = advanced;
            Create = create;
