...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class RoleManifestDashboardsModel
    {
        /// <summary>
        /// Initializes a new instance of the RoleManifestDashboardsModel
        /// class.
        /// </summary>
        public RoleManifestDashboardsModel()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        public RoleManifestDashboardsModel(bool? create = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportDash = default(bool?), bool? exportJpeg = default(bool?), bool? exportPdf = default(bool?), RoleManifestDashboardsFiltersModel filters = default(RoleManifestDashboardsFiltersModel), bool? import = default(bool?), bool? rename = default(bool?), bool? restore = default(bool?), bool? selectPalette = default(bool?), bool? toggleEditMode = default(bool?))
        {
            Create = create;
            Duplicate = duplicate;
        ...
        public RoleManifestDashboardsFiltersModel Filters { get; set; }
