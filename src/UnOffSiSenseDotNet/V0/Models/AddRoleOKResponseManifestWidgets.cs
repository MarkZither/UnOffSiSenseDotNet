...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class AddRoleOKResponseManifestWidgets
    {
        /// <summary>
        /// Initializes a new instance of the AddRoleOKResponseManifestWidgets
        /// class.
        /// </summary>
        public AddRoleOKResponseManifestWidgets()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        public AddRoleOKResponseManifestWidgets(bool? changeType = default(bool?), bool? create = default(bool?), bool? delete = default(bool?), bool? drillToAnywhere = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportCsv = default(bool?), bool? exportPng = default(bool?), AddRoleOKResponseManifestWidgetsFilters filters = default(AddRoleOKResponseManifestWidgetsFilters), AddRoleOKResponseManifestWidgetsItems items = default(AddRoleOKResponseManifestWidgetsItems), bool? modifySelectionMode = default(bool?), bool? rename = default(bool?))
        {
        ...
        public AddRoleOKResponseManifestWidgetsFilters Filters { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "items")]
        public AddRoleOKResponseManifestWidgetsItems Items { get; set; }
