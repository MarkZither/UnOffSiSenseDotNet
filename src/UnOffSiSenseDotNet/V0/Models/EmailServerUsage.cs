...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    /// </summary>
    public partial class EmailServerUsage
    {
        /// <summary>
        /// Initializes a new instance of the EmailServerUsage class.
        /// </summary>
        public EmailServerUsage()
        {
            CustomInit();
        }
        ...
        /// on.</param>
        public EmailServerUsage(bool? enabled = default(bool?), bool? restoreDashboards = default(bool?))
        {
            Enabled = enabled;
