...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class GetOKResponseModelModel
    {
        ...
        /// Initializes a new instance of the GetOKResponseModelModel class.
        /// </summary>
        public GetOKResponseModelModel(bool? enabled = default(bool?), string ip = default(string), double? port = default(double?), string username = default(string), string password = default(string))
        {
            Enabled = enabled;
            Ip = ip;
            Port = port;
