...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class AddRoleOKResponseManifestDashboards
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AddRoleOKResponseManifestDashboards class.
        /// </summary>
        public AddRoleOKResponseManifestDashboards()
        {
            CustomInit();
        }
        ...
        /// AddRoleOKResponseManifestDashboards class.
        /// </summary>
        public AddRoleOKResponseManifestDashboards(bool? create = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportDash = default(bool?), bool? exportJpeg = default(bool?), bool? exportPdf = default(bool?), AddRoleOKResponseManifestDashboardsFilters filters = default(AddRoleOKResponseManifestDashboardsFilters), bool? import = default(bool?), bool? rename = default(bool?), bool? restore = default(bool?), bool? selectPalette = default(bool?), bool? toggleEditMode = default(bool?))
        {
            Create = create;
            Duplicate = duplicate;
        ...
        public AddRoleOKResponseManifestDashboardsFilters Filters { get; set; }
