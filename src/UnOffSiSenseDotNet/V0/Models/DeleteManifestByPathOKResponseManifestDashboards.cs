...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class DeleteManifestByPathOKResponseManifestDashboards
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DeleteManifestByPathOKResponseManifestDashboards class.
        /// </summary>
        public DeleteManifestByPathOKResponseManifestDashboards()
        {
            CustomInit();
        }
        ...
        /// DeleteManifestByPathOKResponseManifestDashboards class.
        /// </summary>
        public DeleteManifestByPathOKResponseManifestDashboards(bool? create = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportDash = default(bool?), bool? exportJpeg = default(bool?), bool? exportPdf = default(bool?), DeleteManifestByPathOKResponseManifestDashboardsFilters filters = default(DeleteManifestByPathOKResponseManifestDashboardsFilters), bool? import = default(bool?), bool? rename = default(bool?), bool? restore = default(bool?), bool? selectPalette = default(bool?), bool? toggleEditMode = default(bool?))
        {
            Create = create;
            Duplicate = duplicate;
        ...
        public DeleteManifestByPathOKResponseManifestDashboardsFilters Filters { get; set; }
