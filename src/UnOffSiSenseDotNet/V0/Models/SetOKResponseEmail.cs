...
namespace UnOffSiSenseDotNet.V0.Models
{
    ...
    public partial class SetOKResponseEmail
    {
        /// <summary>
        /// Initializes a new instance of the SetOKResponseEmail class.
        /// </summary>
        public SetOKResponseEmail()
        {
            CustomInit();
        }
        ...
        public SetOKResponseEmail(bool? enabled = default(bool?), string senderEmail = default(string), string senderName = default(string))
        {
            Enabled = enabled;
