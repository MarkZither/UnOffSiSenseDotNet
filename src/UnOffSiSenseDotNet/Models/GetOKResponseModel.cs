...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class GetOKResponseModel
    {
        ...
        public GetOKResponseModel(string name = default(string), string language = default(string), GetOKResponseLocalization localization = default(GetOKResponseLocalization))
        {
            Name = name;
            Language = language;
        ...
        public GetOKResponseLocalization Localization { get; set; }
