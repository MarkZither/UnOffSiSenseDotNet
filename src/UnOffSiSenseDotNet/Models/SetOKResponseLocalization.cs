...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class SetOKResponseLocalization
    {
        /// <summary>
        /// Initializes a new instance of the SetOKResponseLocalization class.
        /// </summary>
        public SetOKResponseLocalization()
        {
            CustomInit();
        }
        ...
        /// enabled.</param>
        public SetOKResponseLocalization(string defaultProperty = default(string), bool? autoDetectEnabled = default(bool?))
        {
