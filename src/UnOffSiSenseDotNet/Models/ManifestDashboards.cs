...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class ManifestDashboards
    {
        /// <summary>
        /// Initializes a new instance of the ManifestDashboards class.
        /// </summary>
        public ManifestDashboards()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the ManifestDashboards class.
        /// </summary>
        public ManifestDashboards(bool? create = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportDash = default(bool?), bool? exportJpeg = default(bool?), bool? exportPdf = default(bool?), ManifestDashboardsFilters filters = default(ManifestDashboardsFilters), bool? import = default(bool?), bool? rename = default(bool?), bool? restore = default(bool?), bool? selectPalette = default(bool?), bool? toggleEditMode = default(bool?))
        {
            Create = create;
            Duplicate = duplicate;
        ...
        public ManifestDashboardsFilters Filters { get; set; }
