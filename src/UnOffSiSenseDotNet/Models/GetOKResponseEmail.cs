...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class GetOKResponseEmail
    {
        /// <summary>
        /// Initializes a new instance of the GetOKResponseEmail class.
        /// </summary>
        public GetOKResponseEmail()
        {
            CustomInit();
        }
        ...
        public GetOKResponseEmail(bool? enabled = default(bool?), string senderEmail = default(string), string senderName = default(string))
        {
            Enabled = enabled;
