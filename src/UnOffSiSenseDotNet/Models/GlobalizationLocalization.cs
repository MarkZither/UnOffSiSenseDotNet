...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class GlobalizationLocalization
    {
        /// <summary>
        /// Initializes a new instance of the GlobalizationLocalization class.
        /// </summary>
        public GlobalizationLocalization()
        {
            CustomInit();
        }
        ...
        /// enabled.</param>
        public GlobalizationLocalization(string defaultProperty = default(string), bool? autoDetectEnabled = default(bool?))
        {
