...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class RoleManifestWidgetsModel
    {
        /// <summary>
        /// Initializes a new instance of the RoleManifestWidgetsModel class.
        /// </summary>
        public RoleManifestWidgetsModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the RoleManifestWidgetsModel class.
        /// </summary>
        public RoleManifestWidgetsModel(bool? changeType = default(bool?), bool? create = default(bool?), bool? delete = default(bool?), bool? drillToAnywhere = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportCsv = default(bool?), bool? exportPng = default(bool?), RoleManifestWidgetsFiltersModel filters = default(RoleManifestWidgetsFiltersModel), RoleManifestWidgetsItemsModel items = default(RoleManifestWidgetsItemsModel), bool? modifySelectionMode = default(bool?), bool? rename = default(bool?))
        {
        ...
        public RoleManifestWidgetsFiltersModel Filters { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "items")]
        public RoleManifestWidgetsItemsModel Items { get; set; }
