...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class GetAllOKResponseItemModel
    {
        /// <summary>
        /// Initializes a new instance of the GetAllOKResponseItemModel class.
        /// </summary>
        public GetAllOKResponseItemModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the GetAllOKResponseItemModel class.
        /// </summary>
        public GetAllOKResponseItemModel(string _id = default(string), string name = default(string), System.DateTime? created = default(System.DateTime?), string mail = default(string), string roleId = default(string), string baseRoleName = default(string), string cnname = default(string), string dn = default(string), IList<string> member = default(IList<string>), string uSNChanged = default(string), string objectSid = default(string), System.DateTime? lastUpdated = default(System.DateTime?), string defaultRole = default(string), string language = default(string), string timeout = default(string))
        {
            this._id = _id;
            Name = name;
            Created = created;
