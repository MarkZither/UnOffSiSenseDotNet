...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class GetManifestByPathOKResponseDashboards
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetManifestByPathOKResponseDashboards class.
        /// </summary>
        public GetManifestByPathOKResponseDashboards()
        {
            CustomInit();
        }
        ...
        /// GetManifestByPathOKResponseDashboards class.
        /// </summary>
        public GetManifestByPathOKResponseDashboards(bool? create = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportDash = default(bool?), bool? exportJpeg = default(bool?), bool? exportPdf = default(bool?), GetManifestByPathOKResponseDashboardsFilters filters = default(GetManifestByPathOKResponseDashboardsFilters), bool? import = default(bool?), bool? rename = default(bool?), bool? restore = default(bool?), bool? selectPalette = default(bool?), bool? toggleEditMode = default(bool?))
        {
            Create = create;
            Duplicate = duplicate;
        ...
        public GetManifestByPathOKResponseDashboardsFilters Filters { get; set; }
