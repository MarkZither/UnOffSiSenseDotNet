...
namespace UnOffSiSenseDotNet.Models
{
    ...
    public partial class ManifestWidgets
    {
        /// <summary>
        /// Initializes a new instance of the ManifestWidgets class.
        /// </summary>
        public ManifestWidgets()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the ManifestWidgets class.
        /// </summary>
        public ManifestWidgets(bool? changeType = default(bool?), bool? create = default(bool?), bool? delete = default(bool?), bool? drillToAnywhere = default(bool?), bool? duplicate = default(bool?), bool? editScript = default(bool?), bool? exportCsv = default(bool?), bool? exportPng = default(bool?), ManifestWidgetsFilters filters = default(ManifestWidgetsFilters), ManifestWidgetsItems items = default(ManifestWidgetsItems), bool? modifySelectionMode = default(bool?), bool? rename = default(bool?))
        {
        ...
        public ManifestWidgetsFilters Filters { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "items")]
        public ManifestWidgetsItems Items { get; set; }
