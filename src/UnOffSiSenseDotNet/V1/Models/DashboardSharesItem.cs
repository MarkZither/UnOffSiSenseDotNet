...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class DashboardSharesItem
    {
        /// <summary>
        /// Initializes a new instance of the DashboardSharesItem class.
        /// </summary>
        public DashboardSharesItem()
        {
            CustomInit();
        }
        ...
        public DashboardSharesItem(string shareId, string type, string rule = default(string), bool? subscribe = default(bool?))
        {
            ShareId = shareId;
            Type = type;
            Rule = rule;
