...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// Plugin object
    /// </summary>
    public partial class NewPluginsItem
    {
        /// <summary>
        /// Initializes a new instance of the NewPluginsItem class.
        /// </summary>
        public NewPluginsItem()
        {
            CustomInit();
        }
        ...
        public NewPluginsItem(string name = default(string), string version = default(string), string lastUpdate = default(string), bool? isEnabled = default(bool?), string folderName = default(string))
        {
            Name = name;
            Version = version;
