...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// </summary>
    public partial class SetSystemSettingsOKResponseUsage
    {
        /// <summary>
        /// Initializes a new instance of the SetSystemSettingsOKResponseUsage
        /// class.
        /// </summary>
        public SetSystemSettingsOKResponseUsage()
        {
            CustomInit();
        }
        ...
        /// on.</param>
        public SetSystemSettingsOKResponseUsage(bool? enabled = default(bool?), bool? restoreDashboards = default(bool?))
        {
            Enabled = enabled;
