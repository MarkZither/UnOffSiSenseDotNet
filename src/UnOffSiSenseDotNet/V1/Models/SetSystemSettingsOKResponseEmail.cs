...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class SetSystemSettingsOKResponseEmail
    {
        /// <summary>
        /// Initializes a new instance of the SetSystemSettingsOKResponseEmail
        /// class.
        /// </summary>
        public SetSystemSettingsOKResponseEmail()
        {
            CustomInit();
        }
        ...
        public SetSystemSettingsOKResponseEmail(bool? enabled = default(bool?), string senderEmail = default(string), string senderName = default(string))
        {
            Enabled = enabled;
