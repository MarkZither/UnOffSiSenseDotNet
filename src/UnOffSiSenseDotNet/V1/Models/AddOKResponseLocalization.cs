...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class AddOKResponseLocalization
    {
        /// <summary>
        /// Initializes a new instance of the AddOKResponseLocalization class.
        /// </summary>
        public AddOKResponseLocalization()
        {
            CustomInit();
        }
        ...
        /// enabled.</param>
        public AddOKResponseLocalization(string defaultProperty = default(string), bool? autoDetectEnabled = default(bool?))
        {
