...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// </summary>
    public partial class ConnectionParameters
    {
        /// <summary>
        ...
        public ConnectionParameters(object connection, string schema = default(string), string table = default(string), int? limit = default(int?), bool? fetchRelations = default(bool?), string sql = default(string))
        {
