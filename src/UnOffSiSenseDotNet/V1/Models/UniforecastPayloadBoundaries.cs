...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class UniforecastPayloadBoundaries
    {
        /// <summary>
        /// Initializes a new instance of the UniforecastPayloadBoundaries
        /// class.
        /// </summary>
        public UniforecastPayloadBoundaries()
        {
            CustomInit();
        }
        ...
        public UniforecastPayloadBoundaries(double? lower = default(double?), double? upper = default(double?), bool? isInt = default(bool?))
        {
            Lower = lower;
            Upper = upper;
            IsInt = isInt;
