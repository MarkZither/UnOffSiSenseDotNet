...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// </summary>
    public partial class GetSystemSettingsOKResponseUsage
    {
        /// <summary>
        /// Initializes a new instance of the GetSystemSettingsOKResponseUsage
        /// class.
        /// </summary>
        public GetSystemSettingsOKResponseUsage()
        {
            CustomInit();
        }
        ...
        /// on.</param>
        public GetSystemSettingsOKResponseUsage(bool? enabled = default(bool?), bool? restoreDashboards = default(bool?))
        {
            Enabled = enabled;
