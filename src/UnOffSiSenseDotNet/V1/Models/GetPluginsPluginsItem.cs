...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// Plugin object
    /// </summary>
    public partial class GetPluginsPluginsItem
    {
        /// <summary>
        /// Initializes a new instance of the GetPluginsPluginsItem class.
        /// </summary>
        public GetPluginsPluginsItem()
        {
            CustomInit();
        }
        ...
        public GetPluginsPluginsItem(string name = default(string), string version = default(string), string lastUpdate = default(string), bool? isEnabled = default(bool?), string folderName = default(string))
        {
            Name = name;
            Version = version;
