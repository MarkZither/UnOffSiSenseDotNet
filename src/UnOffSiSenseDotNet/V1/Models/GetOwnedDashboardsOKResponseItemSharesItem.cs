...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class GetOwnedDashboardsOKResponseItemSharesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetOwnedDashboardsOKResponseItemSharesItem class.
        /// </summary>
        public GetOwnedDashboardsOKResponseItemSharesItem()
        {
            CustomInit();
        }
        ...
        public GetOwnedDashboardsOKResponseItemSharesItem(string shareId, string type, string rule = default(string), bool? subscribe = default(bool?))
        {
            ShareId = shareId;
            Type = type;
            Rule = rule;
