...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class LiveConnectorConnectionBody
    {
        /// <summary>
        /// Initializes a new instance of the LiveConnectorConnectionBody
        /// class.
        /// </summary>
        public LiveConnectorConnectionBody()
        {
            CustomInit();
        }
        ...
        public LiveConnectorConnectionBody(object connection, string schema = default(string), string table = default(string), double? limit = default(double?), bool? fetchRelations = default(bool?), string sql = default(string))
        {
