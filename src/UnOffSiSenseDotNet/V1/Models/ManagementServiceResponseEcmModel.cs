...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    /// <summary>
    /// ManagementServiceResponseEcmModel
    /// </summary>
    public partial class ManagementServiceResponseEcmModel
    {
        /// <summary>
        /// Initializes a new instance of the ManagementServiceResponseEcmModel
        /// class.
        /// </summary>
        public ManagementServiceResponseEcmModel()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseEcmModel(string error = default(string), string status = default(string), int? statusCode = default(int?), EcmModel value = default(EcmModel))
        {
            Error = error;
            Status = status;
