...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AlertCondition class.
        /// </summary>
        ...
        /// 'smart'</param>
        public AlertCondition(string type, double? leftOperand = default(double?), string operatorProperty = default(string), double? rightOperand = default(double?))
        {
            Type = type;
