...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class LiveElasticubeToAddSharesItem
    {
        /// <summary>
        /// Initializes a new instance of the LiveElasticubeToAddSharesItem
        /// class.
        /// </summary>
        public LiveElasticubeToAddSharesItem()
        {
            CustomInit();
        }
        ...
        public LiveElasticubeToAddSharesItem(string partyId, string permission, string type)
        {
            PartyId = partyId;
