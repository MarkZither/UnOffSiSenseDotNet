...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class MultiforecastPayloadBoundaries
    {
        /// <summary>
        /// Initializes a new instance of the MultiforecastPayloadBoundaries
        /// class.
        /// </summary>
        public MultiforecastPayloadBoundaries()
        {
            CustomInit();
        }
        ...
        public MultiforecastPayloadBoundaries(double? lower = default(double?), double? upper = default(double?), bool? isInt = default(bool?))
        {
            Lower = lower;
            Upper = upper;
            IsInt = isInt;
