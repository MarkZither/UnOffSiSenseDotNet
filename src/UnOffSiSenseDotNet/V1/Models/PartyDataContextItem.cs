...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class PartyDataContextItem
    {
        /// <summary>
        /// Initializes a new instance of the PartyDataContextItem class.
        /// </summary>
        public PartyDataContextItem()
        {
            CustomInit();
        }
        ...
        /// 'default'</param>
        public PartyDataContextItem(string type, string partyId = default(string))
        {
            PartyId = partyId;
            Type = type;
            CustomInit();
