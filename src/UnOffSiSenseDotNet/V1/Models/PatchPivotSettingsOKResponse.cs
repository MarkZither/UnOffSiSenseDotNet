...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class PatchPivotSettingsOKResponse
    {
        /// <summary>
        /// Initializes a new instance of the PatchPivotSettingsOKResponse
        /// class.
        /// </summary>
        public PatchPivotSettingsOKResponse()
        {
            CustomInit();
        }
        ...
        public PatchPivotSettingsOKResponse(int? limit = default(int?), int? columnsLimit = default(int?), bool? allowHtml = default(bool?))
        {
            Limit = limit;
