...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class GetPivotSettingsOKResponse
    {
        /// <summary>
        /// Initializes a new instance of the GetPivotSettingsOKResponse class.
        /// </summary>
        public GetPivotSettingsOKResponse()
        {
            CustomInit();
        }
        ...
        public GetPivotSettingsOKResponse(int? limit = default(int?), int? columnsLimit = default(int?), bool? allowHtml = default(bool?))
        {
            Limit = limit;
