...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class UpdateOKResponseLocalization
    {
        /// <summary>
        /// Initializes a new instance of the UpdateOKResponseLocalization
        /// class.
        /// </summary>
        public UpdateOKResponseLocalization()
        {
            CustomInit();
        }
        ...
        /// enabled.</param>
        public UpdateOKResponseLocalization(string defaultProperty = default(string), bool? autoDetectEnabled = default(bool?))
        {
