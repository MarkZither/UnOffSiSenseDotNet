...
namespace UnOffSiSenseDotNet.V1.Models
{
    ...
    public partial class GetSystemSettingsOKResponseEmail
    {
        /// <summary>
        /// Initializes a new instance of the GetSystemSettingsOKResponseEmail
        /// class.
        /// </summary>
        public GetSystemSettingsOKResponseEmail()
        {
            CustomInit();
        }
        ...
        public GetSystemSettingsOKResponseEmail(bool? enabled = default(bool?), string senderEmail = default(string), string senderName = default(string))
        {
            Enabled = enabled;
