...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ConnectionInput class.
        /// </summary>
        ...
        /// See [Available connectors](http://about:blank)</param>
        public ConnectionInput(string provider, object parameters, string schema = default(string), string fileName = default(string), int? timeout = default(int?), int? refreshRate = default(int?), int? resultLimit = default(int?), object uiParams = default(object), object globalTableConfigOptions = default(object))
        {
            Provider = provider;
