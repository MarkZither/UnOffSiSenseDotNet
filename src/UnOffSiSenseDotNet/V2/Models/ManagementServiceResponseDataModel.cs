...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseDataModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseDataModel class.
        /// </summary>
        public ManagementServiceResponseDataModel()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseDataModel(string error = default(string), string status = default(string), int? statusCode = default(int?), DataModel value = default(DataModel))
        {
            Error = error;
            Status = status;
