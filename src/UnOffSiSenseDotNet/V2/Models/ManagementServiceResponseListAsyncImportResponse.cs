...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseListAsyncImportResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseListAsyncImportResponse class.
        /// </summary>
        public ManagementServiceResponseListAsyncImportResponse()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseListAsyncImportResponse(string error = default(string), string status = default(string), int? statusCode = default(int?), IList<AsyncImportResponse> value = default(IList<AsyncImportResponse>))
        {
            Error = error;
            Status = status;
        ...
        public IList<AsyncImportResponse> Value { get; set; }
