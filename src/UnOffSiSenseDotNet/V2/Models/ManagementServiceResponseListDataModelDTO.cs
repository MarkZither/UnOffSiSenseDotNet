...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseListDataModelDTO
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseListDataModelDTO class.
        /// </summary>
        public ManagementServiceResponseListDataModelDTO()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseListDataModelDTO(string error = default(string), string status = default(string), int? statusCode = default(int?), IList<DataModelDTO> value = default(IList<DataModelDTO>))
        {
            Error = error;
            Status = status;
        ...
        public IList<DataModelDTO> Value { get; set; }
