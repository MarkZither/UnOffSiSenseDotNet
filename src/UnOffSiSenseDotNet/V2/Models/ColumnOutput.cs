...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ColumnOutput class.
        /// </summary>
        public ColumnOutput()
        {
            CustomInit();
        ...
        /// queries</param>
        /// <param name="oid">Unique ID assigned to the Column</param>
        ...
        /// columns**</param>
        public ColumnOutput(string id = default(string), string name = default(string), System.Guid? oid = default(System.Guid?), int? type = default(int?), int? size = default(int?), int? precision = default(int?), int? scale = default(int?), bool? hidden = default(bool?), bool? indexed = default(bool?), string description = default(string), bool? import = default(bool?), bool? isCustom = default(bool?), ColumnOutputExpression expression = default(ColumnOutputExpression))
        {
            Id = id;
            Name = name;
            Oid = oid;
        ...
        /// <summary>
        /// Gets or sets unique ID assigned to the Column
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets **Only applicable to `custom` type columns**
        /// </summary>
        [JsonProperty(PropertyName = "expression")]
        public ColumnOutputExpression Expression { get; set; }
