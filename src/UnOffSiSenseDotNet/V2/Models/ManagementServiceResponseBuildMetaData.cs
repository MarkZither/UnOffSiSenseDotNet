...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseBuildMetaData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseBuildMetaData class.
        /// </summary>
        public ManagementServiceResponseBuildMetaData()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseBuildMetaData(string error = default(string), string status = default(string), int? statusCode = default(int?), BuildMetaData value = default(BuildMetaData))
        {
            Error = error;
            Status = status;
        ...
        public BuildMetaData Value { get; set; }
