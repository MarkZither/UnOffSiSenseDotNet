...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseWithoutValue
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseWithoutValue class.
        /// </summary>
        public ManagementServiceResponseWithoutValue()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseWithoutValue(string error = default(string), string status = default(string))
        {
            Error = error;
            Status = status;
            CustomInit();
