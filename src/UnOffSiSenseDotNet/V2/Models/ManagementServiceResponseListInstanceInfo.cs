...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseListInstanceInfo
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseListInstanceInfo class.
        /// </summary>
        public ManagementServiceResponseListInstanceInfo()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseListInstanceInfo(string error = default(string), string status = default(string), int? statusCode = default(int?), IList<InstanceInfo> value = default(IList<InstanceInfo>))
        {
            Error = error;
            Status = status;
        ...
        public IList<InstanceInfo> Value { get; set; }
