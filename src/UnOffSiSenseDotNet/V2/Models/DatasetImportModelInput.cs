...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    public partial class DatasetImportModelInput
    {
        /// <summary>
        /// Initializes a new instance of the DatasetImportModelInput class.
        /// </summary>
        public DatasetImportModelInput()
        {
            CustomInit();
        }
        ...
        public DatasetImportModelInput(string name, string type, System.Guid? oid = default(System.Guid?), ConnectionImportModelInput connection = default(ConnectionImportModelInput))
        {
            Oid = oid;
            Name = name;
            Type = type;
        ...
        public ConnectionImportModelInput Connection { get; set; }
