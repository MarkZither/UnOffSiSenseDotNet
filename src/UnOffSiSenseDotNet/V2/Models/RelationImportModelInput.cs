...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    public partial class RelationImportModelInput
    {
        /// <summary>
        /// Initializes a new instance of the RelationImportModelInput class.
        /// </summary>
        public RelationImportModelInput()
        {
            CustomInit();
        }
        ...
        public RelationImportModelInput(IList<RelationFieldInput> columns)
        {
            Columns = columns;
            CustomInit();
        }
