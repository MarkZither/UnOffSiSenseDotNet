...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseListDataModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseListDataModel class.
        /// </summary>
        public ManagementServiceResponseListDataModel()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseListDataModel(string error = default(string), string status = default(string), int? statusCode = default(int?), IList<DataModel> value = default(IList<DataModel>))
        {
            Error = error;
            Status = status;
        ...
        public IList<DataModel> Value { get; set; }
