...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseListAsyncExportResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseListAsyncExportResponse class.
        /// </summary>
        public ManagementServiceResponseListAsyncExportResponse()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseListAsyncExportResponse(string error = default(string), string status = default(string), int? statusCode = default(int?), IList<AsyncExportResponse> value = default(IList<AsyncExportResponse>))
        {
            Error = error;
            Status = status;
        ...
        public IList<AsyncExportResponse> Value { get; set; }
