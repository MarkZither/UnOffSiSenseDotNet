...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseLogicalDbSchema
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseLogicalDbSchema class.
        /// </summary>
        public ManagementServiceResponseLogicalDbSchema()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseLogicalDbSchema(string error = default(string), string status = default(string), int? statusCode = default(int?), LogicalDbSchema value = default(LogicalDbSchema))
        {
            Error = error;
            Status = status;
        ...
        public LogicalDbSchema Value { get; set; }
