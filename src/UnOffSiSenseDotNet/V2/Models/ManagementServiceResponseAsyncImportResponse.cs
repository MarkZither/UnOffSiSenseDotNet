...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// </summary>
    public partial class ManagementServiceResponseAsyncImportResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ManagementServiceResponseAsyncImportResponse class.
        /// </summary>
        public ManagementServiceResponseAsyncImportResponse()
        {
            CustomInit();
        }
        ...
        public ManagementServiceResponseAsyncImportResponse(string error = default(string), string status = default(string), int? statusCode = default(int?), AsyncImportResponse value = default(AsyncImportResponse))
        {
            Error = error;
            Status = status;
        ...
        public AsyncImportResponse Value { get; set; }
