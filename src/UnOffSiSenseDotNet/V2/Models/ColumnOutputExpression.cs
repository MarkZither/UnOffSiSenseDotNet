...
namespace UnOffSiSenseDotNet.V2_0.Models
{
    ...
    /// <summary>
    /// **Only applicable to `custom` type columns**
    /// </summary>
    public partial class ColumnOutputExpression
    {
        /// <summary>
        /// Initializes a new instance of the ColumnOutputExpression class.
        /// </summary>
        public ColumnOutputExpression()
        {
            CustomInit();
        }
        ...
        /// change</param>
        public ColumnOutputExpression(System.Guid? oid = default(System.Guid?), string expression = default(string), System.DateTime? lastUpdated = default(System.DateTime?))
        {
            Oid = oid;
