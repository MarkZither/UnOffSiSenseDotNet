...
namespace UnOffSiSenseDotNet.test.V1
{
    public class SiSenseSDKTests
    {
        ...
        [Fact]
        public async Task GetOwnedDashboardsWithHttpMessagesAsync_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
            var siSenseSDK = this.CreateSiSenseSDK();
            string authorization = null;
            ...
            // Act
            var result = await siSenseSDK.GetOwnedDashboardsWithHttpMessagesAsync(
                authorization,
                parentFolder,
                name,
                datasourceTitle,
        ...
        [Fact]
        public async Task AddDashboardWithHttpMessagesAsync_StateUnderTest_ExpectedBehavior()
        {
            // Arrange
            var siSenseSDK = this.CreateSiSenseSDK();
            ...
            // Act
            var result = await siSenseSDK.AddDashboardWithHttpMessagesAsync(
                dashboard,
                authorization,
                customHeaders,
                cancellationToken);
